...
<acme:form>
	...
	<acme:input-moment code="developer.training-session.form.label.initialPeriod" path="initialPeriod" />
	<acme:input-moment code="developer.training-session.form.label.finalPeriod" path="finalPeriod"/>
