...
<acme:list>
	...
	<acme:list-column code="developer.training-session.list.label.initialPeriod" path="initialPeriod" width="20%"/>	
	<acme:list-column code="developer.training-session.list.label.finalPeriod" path="finalPeriod" width="20%"/>	
